...
* The original package name 'com.soc.backend-core' is invalid and this project uses 'com.soc.backend_core' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/3.5.13/reference/messaging/kafka.html)
